...
void saveTransactionTest(void) {
  ST_transaction_t test = { {"Nour Magdy", "11111111111111111","11/26"},{500,20000,"10/05/2023"}, 0 };
  char* test_text = "{ {\"Nour Magdy\", \"11111111111111111\",\"11/26\"},{500,20000,\"10/05/2023\"}, 0 }";
  char* expected_output = "#########################\nTransaction Sequence Number : 0\nTransaction Date : 10/05/2023\nTransaction Amount : 500.00\nTransaction State : APPROVED\nTerminal Max Amount : 20000.00\nCardholder Name : Nour Magdy\nPAN : 11111111111111111\nCard Expiration Date : 11/26\n#########################\n";
  printf("Tester Name: Nour Magdy\n");
